---
source_url: https://docs.lightly.ai/train/stable/pretrain_distill/models/timm.html
---
...
[TIMM](https://github.com/huggingface/pytorch-image-models) must be installed with `pip install "lightly-train[timm]"`.

## Pretrain and Fine-tune a TIMM ModelÂ¶

### PretrainÂ¶

Pretraining TIMM models with LightlyTrain is straightforward. Below we provide the minimum scripts for pretraining using `timm/resnet18` as an example:
